function [accumulator] = dynamic_smoothing(post_probabilities, feedback_starts, alpha, beta, free_force, bmi_force)
% [accumulator] = dynamic_smoothing(post_probabilities, feedback_starts, alpha, beta, free_force, bmi_force)
%
