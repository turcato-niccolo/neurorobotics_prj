function [PSD_out, frequencies] = extract_frequencies(PSD_in , original_freqs, selected_freqs)
% [PSD_out, freqs] = extract_frequencies(PSD_in , original_freqs, selected_freqs)
%
